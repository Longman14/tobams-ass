...
export default function ManagementDevelopmentProgram() {
  return (
    <section className="bg-[#2C0922] rounded-[20px] px-6 py-6 lg:py-10 lg:px-10 lg:mx-16 my-4 lg:my-16 mx-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-center">
        <h2 className="order-1 md:hidden text-xl font-semibold font-display text-white leading-snug">
        ...
        <div className="order-3 md:order-2">
          <h2 className="hidden md:block text-xl md:text-3xl lg:text-5xl font-semibold font-display text-white mb-3 lg:mb-4 leading-snug">
            Management Development Program
          </h2>

          <p className="text-base lg:text-lg text-white leading-7 lg:leading-relaxed tracking-wide mb-3 lg:mb-3">
          ...
          <p className="text-base lg:text-lg text-white leading-7 lg:leading-relaxed tracking-wide mb-5 lg:mb-8">
          ...
          <ul className="flex flex-col gap-5 lg:gap-6.5">
            {features.map((feature) => (
              <li
                key={feature}
                className="flex items-center gap-2 bg-[#8f6182] rounded-lg px-4 py-3 text-base lg:text-lg leading-6 lg:leading-normal text-white"
              >
